  ...
  return (
    <div className="w-full  p-4">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div>
          <label className="block text-sm font-medium mb-1">Jenis Siswa :</label>
          <Input
            type="text"
            placeholder="Enter jenis siswa"
            className="w-full"
          />
        </div>
        <div>
          ...
          <Input
            type="text"
            placeholder="Enter unit kompetensi"
            className="w-full"
          />
        </div>
        <div>
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              className=" text-white hover:text-white bg-blue-700 hover:bg-blue-800"
              ...
              {rows.map((row) => (
                <tr key={row.id} className=" border-[2px] border-b-black shadow-none">
                  ...
                  <td className="py-2 px-4">
                    <Input type="text" className="w-full shadow-none" />
                  </td>
                  <td className="py-2 px-4">
      ...
      <div className="flex justify-between items-center">
        <Button
          onClick={addRow}
          variant="outline"
          className="border-2 border-gray-300 p-2 rounded-full w-8 h-8 flex items-center justify-center"
        >
          +
        </Button>
