...
const handleImageError = (e) => {
  e.target.src = '/src/assets/Skema/sekretaris.png';
};
...
const CardItem = ({ id, title, subtitle, imageUrl }) => (
  <Card className="relative group overflow-hidden shadow-lg rounded-lg bg-white transition-all duration-300 ease-in-out hover:scale-105">
    <CardContent className="relative p-0">
      <img src={imageUrl} alt={title} className="w-full h-64 object-cover transition-all duration-300 group-hover:opacity-60" onError={handleImageError} />
