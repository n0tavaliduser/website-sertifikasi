            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              <NavLink to="/" className="">
                <div className="px-3 py-2 inline-block lg:flex items-center text-md font-semibold leading-snug">
                  <div className="ml-2 mt-1 flex items-center lg:hover:underline">Beranda</div>
                </div>
              </NavLink>
              <NavLink to="../Partnership" className="">
                <div className="px-3 py-2 inline-block lg:flex items-center text-md font-semibold leading-snug">
                  <div className="ml-2 mt-1 flex items-center lg:hover:underline">Partnership</div>
                </div>
              </NavLink>
              <NavLink to="../Tentang" className="">
                <div className="px-3 py-2 inline-block lg:flex items-center text-md font-semibold leading-snug">
                  <div className="ml-2 mt-1 flex items-center lg:hover:underline">Tentang</div>
                </div>
              </NavLink>
              <NavLink to="../Skema" className="">
                <div className="px-3 py-2 inline-block lg:flex items-center text-md font-semibold leading-snug">
                  <div className="ml-2 mt-1 flex items-center lg:hover:underline">Skema</div>
                </div>
              </NavLink>
              <NavLink to="../Tuks" className="">
                <div className="px-3 py-2 inline-block lg:flex items-center text-md font-semibold leading-snug">
                  <div className="ml-2 mt-1 flex items-center lg:hover:underline">TUKS</div>
                </div>
              </NavLink>
              <NavLink to="../Galeri" className="">
                <div className="px-3 py-2 inline-block lg:flex items-center text-md font-semibold leading-snug">
                  <div className="ml-2 mt-1 flex items-center lg:hover:underline">Galeri</div>
                </div>
              </NavLink>
              <NavLink to="../Berita" className="">
                <div className="px-3 py-2 inline-block lg:flex items-center text-md font-semibold leading-snug">
                  <div className="ml-2 mt-1 flex items-center lg:hover:underline">Berita</div>
                </div>
              </NavLink>
              <NavLink to="../Kontak" className="">
                <div className="px-3 py-2 inline-block lg:flex items-center text-md font-semibold leading-snug">
                  <div className="ml-2 mt-1 flex items-center lg:hover:underline">Kontak</div>
                </div>
              </NavLink>
              <NavLink to="../auth/login" className="">
                <div className="px-3 py-2 inline-block lg:flex items-center text-md font-semibold leading-snug">
                  <div className="ml-2 mt-1 flex items-center lg:hover:underline">Login</div>
                </div>
              </NavLink>
            </ul>
          </div>
